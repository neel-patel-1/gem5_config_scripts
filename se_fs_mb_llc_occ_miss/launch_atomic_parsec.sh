...
SE_PATH=/opt/shared/gem5-learning/gem5/configs/example/gem5_library/x86-atomic-parsec-benchmarks.py
...
OUTDIR=se_fs_sys_comparison/${OUTDIR}_atomic_fs_gem5_monitoring
#BENCHMARK
