...
export ARGS="1 /opt/shared/parsec_native/parsec-3.0/pkgs/apps/blackscholes/run/in_64K.txt /opt/shared/parsec_native/parsec-3.0/pkgs/apps/blackscholes/run/prices.txt "
export OUTDIR=blacksholes_large
